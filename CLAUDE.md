...
This is a **Design System** React component library with Storybook documentation, published via GitHub Packages.
...
| Colors | `--color-{category}-{name}` | `color: var(--color-brand-primary)` |
...
- **Package:** Auto-publishes to GitHub Packages on push (patch version bump)
